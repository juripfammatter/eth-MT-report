...
\begin{figure}[h]
    ...
    \end{subfigure}
    \hfill
    \caption{Experimental setup. {\color{cyan}Cyan} indicates the initial distribution, {\color{teal} green} the target goal, and the black/white box represents the task space.}\label{fig:experiment_renders}
\end{figure}
...
\begin{figure}[h]
    ...
    \end{subfigure}
    \hfill\strut{}
    \caption{Samples of the explored regions on the real-world terrain at different training iterations. {\color{blue} Blue} indicates the intermediate goals (forward expansion), {\color{orange} orange} indicates the initial states (backward expansion), {\color{cyan}cyan} indicates the initial distribution, and the black/white box represents the task space.}\label{fig:scans}
\end{figure}
