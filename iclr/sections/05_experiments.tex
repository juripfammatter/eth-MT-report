...
\begin{wrapfigure}{r}{0.4\linewidth}
    ...
    \caption{Path diversity on the three-route terrain. PPO without a curriculum collapses onto the ramp, while BVER learns to traverse all three terrains.}\label{fig:eval_path_diversity}
\end{wrapfigure}
