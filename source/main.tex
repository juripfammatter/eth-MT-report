...
\studentA{Juri Pfammatter}
% \studentC{Student 3}

% TODO Add name of the supervisors
\supervisionA{Victor Klemm}
\supervisionB{Clemens Schwarke}
\supervisionC{Kaixian Qu}
...
\input{chapters/pre/00_declaration}
\clearpage
\input{chapters/pre/00_declaration_generative_ai}\clearpage % Comment line if "no generative AI" was selected in declaration
\input{chapters/pre/00_transfer.tex}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Table on contents
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% Chapters standard
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% \input{chapters/pre/00_preface}
% \cleardoublepage{}
\input{chapters/01_abstract}
\cleardoublepage{}
\input{chapters/pre/00_symbols}
\cleardoublepage{}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\appendix
\input{chapters/99_appendix_text}
\cleardoublepage{}
