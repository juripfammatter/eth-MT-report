...
\begin{multicols}{2}
    \begin{itemize}[label={}, itemsep=0pt, parsep=0pt]
        ...
        \item[$\blacksquare$] \mbox{Text refinement (incl. Grammarly, Writefull)}
        \item[$\square$] \mbox{Presentation refinement (incl. 365 Copilot)}
        \item[$\blacksquare$] \mbox{Code generation/debugging/optimization}
...
% Signature section
\noindent
\textbf{Signature:} \rule{5cm}{0.4pt} \hfill \textbf{Date:}\;\today{}
